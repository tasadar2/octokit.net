    ...
    public class ObservableEnterprisePreReceiveHooksClientTests
    {
        ...
        public class TheGetMethod
        {
            ...
            public void RequestsTheCorrectUrl()
            {
                ...
                gitHubClient.Enterprise.PreReceiveHooks.Received(1).Get(1);
            }
        }
        ...
        public class TheCreateMethod
        {
            ...
            public void RequestsTheCorrectUrl()
            {
                ...
                gitHubClient.Enterprise.PreReceiveHooks.Received(1).Create(data);
            }
        ...
        public class TheEditMethod
        {
            ...
            public void RequestsTheCorrectUrl()
            {
                ...
                gitHubClient.Enterprise.PreReceiveHooks.Received(1).Edit(1, data);
            }
        ...
        public class TheDeleteMethod
        {
            ...
            public void RequestsTheCorrectUrl()
            {
                ...
                gitHubClient.Enterprise.PreReceiveHooks.Received(1).Delete(1);
            }
        }
    }
}
